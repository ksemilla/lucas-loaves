          ...
          <div>
            <div className="text-base leading-7 text-gray-700 lg:max-w-lg">
              ...
              <h1 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                I'm Luca, the owner of Luca's Loaves
              </h1>
              <div className="max-w-xl">
                <p className="mt-6">Key facts about Luca and the bread!</p>
                <p className="mt-8">
                  Luca commenced his career as a lifeguard but was laid off. He
                  found he enjoyed making bread and experimented and in no time
                  at all had built up a thriving business.
                </p>
              </div>
            </div>
